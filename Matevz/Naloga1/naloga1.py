...
all_zero_rows_ixs = np.all(constructed_data == 0, axis=1)
# print("all_zero_rows_ixs")
# print(all_zero_rows_ixs)

# remove these rows
constructed_data = constructed_data[~all_zero_rows_ixs]
row_labels = row_labels[~all_zero_rows_ixs]
from_count_voted_in_edition = from_count_voted_in_edition[~all_zero_rows_ixs]
